...
import { Prisma, EnumSettingVehicleType, EnumSettingDeliverySpeed } from '@prisma/types'
...
export class CourierFullSettingsAdminDto implements Partial<CourierSettingEntity> {
  ...
  constructor(data: CourierSettingEntity) {
