/*
  ...
  - The values [OPENDELLI] on the enum `EnumDeliveryEventSource` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "EnumDeliveryEventSource_new" AS ENUM ('OPENDELI');
...
-- AlterEnum
ALTER TYPE "EnumEventActor" ADD VALUE 'PARTNER';
